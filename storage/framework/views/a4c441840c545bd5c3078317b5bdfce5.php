...
<form method='post' action='<?php echo e(url("/final/{$data->nim}")); ?>' >
    <?php echo csrf_field(); ?>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='major' value="<?php echo e($data->major); ?>" id="major">
            </div>
        </div>
        <div class="mb-3 row">
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\finalproject\resources\views/project/edit.blade.php ENDPATH**/ ?>